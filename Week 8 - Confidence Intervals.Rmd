...
```
---
title: "Week 8 - Confident Intervals for T-Tests"
...
Interpretation: We are 95% confident that the CI [51.59, 72.41] contains the true population mean. 
...
t.test(grades$Posttest, grades$Pretest, var.equal=F, paired=T)
```
...
APA conclustion: A related samples t-test revealed a statistically significant difference between pre-test (M=70.22, SD=9.22) and post-test (M=76.56, SD=9.30) grades; t(8)=3.45, p<0.05, d=1.15. Cohen's d signified a large effect.
